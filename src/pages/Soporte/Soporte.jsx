...
function Soporte() {
  ...
  const correoSoporte = "estefaniamoon6@gmail.com";

  const numeroSoporte = "13531018343";
  ...
  const preguntasFiltradas = useMemo(() => {
    ...
    return preguntas.filter((item) => {
      return (
        item.pregunta.toLowerCase().includes(texto) ||
        item.respuesta.toLowerCase().includes(texto)
      );
    });
  }, [busqueda]);
  ...
  const guardarReporteLocal = () => {
    const reportes = JSON.parse(localStorage.getItem("reportesSoporte")) || [];
...
`;
  ...
  const enviarWhatsApp = () => {
    ...
    const enlaceWhatsApp =
      `https://wa.me/${numeroSoporte}` + `?text=${encodeURIComponent(mensaje)}`;
      ...
      <main className="soporte-main">
        ...
        <section className="soporte-grid">
          ...
          <article className="soporte-card">
            <div className="soporte-card-icono"></div>

            <h2>Preguntas frecuentes</h2>

            <p>
              Encuentra respuestas rápidas sobre el funcionamiento de StepAI.
            </p>
          ...
          <article className="soporte-card">
            ...
            <p>Aprende a utilizar las principales funciones de StepAI.</p>

            <button
              type="button"
              className="soporte-card-btn"
              onClick={() => {
                document.getElementById("guia-uso")?.scrollIntoView({
                  behavior: "smooth",
                });
              }}
            >
          ...
          <article className="soporte-card">
            ...
            <p>Envía un reporte directamente por correo o WhatsApp.</p>
          ...
          <article className="soporte-card">
            ...
            <p>Consulta información útil para identificar problemas.</p>

            <button
              type="button"
              className="soporte-card-btn"
              onClick={() => {
                document.getElementById("informacion-sistema")?.scrollIntoView({
                  behavior: "smooth",
                });
              }}
            >
        ...
        <section id="preguntas-frecuentes" className="soporte-seccion">
                ...
                return (
                  <div className="faq-item" key={item.pregunta}>
                    <button
                      ...
                      onClick={() => setPreguntaAbierta(abierto ? null : index)}
                    >
        ...
        <section id="guia-uso" className="soporte-seccion">
          <div className="soporte-seccion-titulo">
            <h2>Guía de uso</h2>
          ...
          <div className="guia-lista">
            <div className="guia-paso">
              ...
              <div>
                ...
                <p>Captura los datos generales del paciente.</p>
              </div>
            ...
            <div className="guia-paso">
              ...
              <div>
                ...
                <p>Completa la información médica.</p>
              </div>
            </div>
            ...
            <div className="guia-paso">
              ...
              <div>
                <h3>Análisis plantar</h3>

                <p>Realiza un nuevo análisis.</p>
              </div>
            ...
            <div className="guia-paso">
              ...
              <div>
                ...
                <p>Guarda diagnóstico, tratamiento y observaciones.</p>
              </div>
            </div>
            ...
            <div className="guia-paso">
              ...
              <div>
                ...
                <p>Consulta las próximas citas programadas.</p>
              </div>
            ...
            <div className="guia-paso">
              ...
              <div>
                ...
                <p>Consulta las actividades realizadas.</p>
              </div>

              <button type="button" onClick={() => navigate("/historial")}>
                Historial
              </button>
            </div>
          </div>
        ...
        <section id="informacion-sistema" className="soporte-seccion">
          <div className="soporte-seccion-titulo">
            <h2>Información del sistema</h2>
          ...
          <div className="soporte-modal">
            <div className="soporte-modal-header">
              <div>
                ...
                <p>Describe el problema encontrado.</p>
              </div>
            ...
            <div className="soporte-form">
              ...
              <div className="soporte-form-group">
                <label>Pantalla donde ocurrió</label>
                ...
                >
                  ...
                  <option value="Panel Principal">Panel Principal</option>

                  <option value="Registro Paciente">Registro Paciente</option>

                  <option value="Datos Médicos">Datos Médicos</option>

                  <option value="Análisis Plantar">Análisis Plantar</option>

                  <option value="Informe Paciente">Informe Paciente</option>
